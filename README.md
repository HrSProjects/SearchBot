...
CONSOLEGOOGLE_APIKEY=CONSOLEGOOGLE_APIKEY
```

## جميع المواقع اللي بتحتاجها عشان الـ API

- ### [Youtube Reference](https://developers.google.com/youtube/v3/docs)
...
5. **تسوي اضافة `Secret` جديد و تكتب الاسم `TOKEN` و بعدها تحت الاسم تلصق توكن البوت حقك و تسوي نفس الشي مع باقي الاشياء اللي تحتاجها**
